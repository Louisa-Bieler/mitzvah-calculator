...
* The original package name 'com.doraisa.mitzvah-calculator' is invalid and this project uses 'com.doraisa.mitzvahcalculator' instead.
...
* [Docker Compose Support](https://docs.spring.io/spring-boot/docs/3.2.0-M2/reference/htmlsingle/index.html#features.docker-compose)
